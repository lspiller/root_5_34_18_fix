...
/* G__exception */
static int G__exception_52_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   G__exception* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
...
static int G__exception_52_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   G__exception* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__exception_52_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   G__exception* p = NULL;
   char* gvp = (char*) G__getgvp();
   switch (libp->paran) {
...
static int G__exception_52_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   G__exception* p = NULL;
   char* gvp = (char*) G__getgvp();
   switch (libp->paran) {
...
static int G__exception_52_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__exception_52_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) ((const G__exception*) G__getstructoffset())->what());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__exception_52_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__exception_52_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
static void G__setup_memfuncG__exception(void) {
   ...
   G__memfunc_setup("G__exception",1236,G__exception_52_0_1, 105, G__get_linked_tagnum(&G__LN_G__exception), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("G__exception",1236,G__exception_52_0_2, 105, G__get_linked_tagnum(&G__LN_G__exception), -1, 0, 1, 1, 1, 0, "u 'G__exception' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("G__exception",1236,G__exception_52_0_3, 105, G__get_linked_tagnum(&G__LN_G__exception), -1, 0, 2, 1, 1, 0, 
"C - - 10 - x C - - 10 '\"\"' cnm", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("G__exception",1236,G__exception_52_0_4, 105, G__get_linked_tagnum(&G__LN_G__exception), -1, 0, 2, 1, 1, 0, 
"u 'string' - 11 - x u 'string' - 11 '\"\"' cnm", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator=",937,G__exception_52_0_5, 117, G__get_linked_tagnum(&G__LN_G__exception), -1, 1, 1, 1, 1, 0, "u 'G__exception' - 11 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("what",436,G__exception_52_0_6, 67, -1, -1, 0, 0, 1, 1, 41, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("name",417,G__exception_52_0_7, 67, -1, -1, 0, 0, 1, 1, 41, "", (char*)NULL, (void*) NULL, 1);
   // automatic destructor
   G__memfunc_setup("~G__exception", 1362, G__exception_52_0_8, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   G__tag_memfunc_reset();
}
